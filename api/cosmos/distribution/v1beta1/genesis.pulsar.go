...
var _ protoreflect.List = (*_ValidatorBonusConfig_1_list)(nil)

type _ValidatorBonusConfig_1_list struct {
	list *[]string
}

func (x *_ValidatorBonusConfig_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ValidatorBonusConfig_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_ValidatorBonusConfig_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_ValidatorBonusConfig_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_ValidatorBonusConfig_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message ValidatorBonusConfig at list field ValidatorWhitelist as it is not of Message kind"))
}

func (x *_ValidatorBonusConfig_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_ValidatorBonusConfig_1_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_ValidatorBonusConfig_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ValidatorBonusConfig                     protoreflect.MessageDescriptor
	fd_ValidatorBonusConfig_validator_whitelist protoreflect.FieldDescriptor
	fd_ValidatorBonusConfig_bonus_height_to     protoreflect.FieldDescriptor
	fd_ValidatorBonusConfig_bonus_percent       protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_genesis_proto_init()
	md_ValidatorBonusConfig = File_cosmos_distribution_v1beta1_genesis_proto.Messages().ByName("ValidatorBonusConfig")
	fd_ValidatorBonusConfig_validator_whitelist = md_ValidatorBonusConfig.Fields().ByName("validator_whitelist")
	fd_ValidatorBonusConfig_bonus_height_to = md_ValidatorBonusConfig.Fields().ByName("bonus_height_to")
	fd_ValidatorBonusConfig_bonus_percent = md_ValidatorBonusConfig.Fields().ByName("bonus_percent")
}

var _ protoreflect.Message = (*fastReflection_ValidatorBonusConfig)(nil)

type fastReflection_ValidatorBonusConfig ValidatorBonusConfig

func (x *ValidatorBonusConfig) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ValidatorBonusConfig)(x)
}

func (x *ValidatorBonusConfig) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ValidatorBonusConfig_messageType fastReflection_ValidatorBonusConfig_messageType
var _ protoreflect.MessageType = fastReflection_ValidatorBonusConfig_messageType{}

type fastReflection_ValidatorBonusConfig_messageType struct{}

func (x fastReflection_ValidatorBonusConfig_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ValidatorBonusConfig)(nil)
}
func (x fastReflection_ValidatorBonusConfig_messageType) New() protoreflect.Message {
	return new(fastReflection_ValidatorBonusConfig)
}
func (x fastReflection_ValidatorBonusConfig_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ValidatorBonusConfig
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ValidatorBonusConfig) Descriptor() protoreflect.MessageDescriptor {
	return md_ValidatorBonusConfig
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ValidatorBonusConfig) Type() protoreflect.MessageType {
	return _fastReflection_ValidatorBonusConfig_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ValidatorBonusConfig) New() protoreflect.Message {
	return new(fastReflection_ValidatorBonusConfig)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ValidatorBonusConfig) Interface() protoreflect.ProtoMessage {
	return (*ValidatorBonusConfig)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ValidatorBonusConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.ValidatorWhitelist) != 0 {
		value := protoreflect.ValueOfList(&_ValidatorBonusConfig_1_list{list: &x.ValidatorWhitelist})
		if !f(fd_ValidatorBonusConfig_validator_whitelist, value) {
			return
		}
	}
	if x.BonusHeightTo != uint64(0) {
		value := protoreflect.ValueOfUint64(x.BonusHeightTo)
		if !f(fd_ValidatorBonusConfig_bonus_height_to, value) {
			return
		}
	}
	if x.BonusPercent != "" {
		value := protoreflect.ValueOfString(x.BonusPercent)
		if !f(fd_ValidatorBonusConfig_bonus_percent, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ValidatorBonusConfig) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		return len(x.ValidatorWhitelist) != 0
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		return x.BonusHeightTo != uint64(0)
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		return x.BonusPercent != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.ValidatorBonusConfig"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.ValidatorBonusConfig does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorBonusConfig) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		x.ValidatorWhitelist = nil
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		x.BonusHeightTo = uint64(0)
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		x.BonusPercent = ""
	default:
		if fd.IsExtension() {
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ValidatorBonusConfig) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		if len(x.ValidatorWhitelist) == 0 {
			return protoreflect.ValueOfList(&_ValidatorBonusConfig_1_list{})
		}
		listValue := &_ValidatorBonusConfig_1_list{list: &x.ValidatorWhitelist}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		value := x.BonusHeightTo
		return protoreflect.ValueOfUint64(value)
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		value := x.BonusPercent
		return protoreflect.ValueOfString(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.ValidatorBonusConfig"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.ValidatorBonusConfig does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorBonusConfig) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		lv := value.List()
		clv := lv.(*_ValidatorBonusConfig_1_list)
		x.ValidatorWhitelist = *clv.list
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		x.BonusHeightTo = value.Uint()
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		x.BonusPercent = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.ValidatorBonusConfig"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorBonusConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		if x.ValidatorWhitelist == nil {
			x.ValidatorWhitelist = []string{}
		}
		value := &_ValidatorBonusConfig_1_list{list: &x.ValidatorWhitelist}
		return protoreflect.ValueOfList(value)
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		panic(fmt.Errorf("field bonus_height_to of message cosmos.distribution.v1beta1.ValidatorBonusConfig is not mutable"))
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		panic(fmt.Errorf("field bonus_percent of message cosmos.distribution.v1beta1.ValidatorBonusConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.ValidatorBonusConfig"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ValidatorBonusConfig) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.validator_whitelist":
		list := []string{}
		return protoreflect.ValueOfList(&_ValidatorBonusConfig_1_list{list: &list})
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_height_to":
		return protoreflect.ValueOfUint64(uint64(0))
	case "cosmos.distribution.v1beta1.ValidatorBonusConfig.bonus_percent":
		return protoreflect.ValueOfString("")
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ValidatorBonusConfig) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.ValidatorBonusConfig", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ValidatorBonusConfig) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ValidatorBonusConfig) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ValidatorBonusConfig) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ValidatorBonusConfig) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ValidatorBonusConfig)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if len(x.ValidatorWhitelist) > 0 {
			for _, s := range x.ValidatorWhitelist {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if x.BonusHeightTo != 0 {
			n += 1 + runtime.Sov(uint64(x.BonusHeightTo))
		}
		l = len(x.BonusPercent)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.BonusPercent) > 0 {
			i -= len(x.BonusPercent)
			copy(dAtA[i:], x.BonusPercent)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.BonusPercent)))
			i--
			dAtA[i] = 0x1a
		}
		if x.BonusHeightTo != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.BonusHeightTo))
			i--
			dAtA[i] = 0x10
		}
		if len(x.ValidatorWhitelist) > 0 {
			for iNdEx := len(x.ValidatorWhitelist) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ValidatorWhitelist[iNdEx])
				copy(dAtA[i:], x.ValidatorWhitelist[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ValidatorWhitelist[iNdEx])))
				i--
				dAtA[i] = 0xa
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ValidatorBonusConfig: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ValidatorBonusConfig: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.ValidatorWhitelist = append(x.ValidatorWhitelist, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BonusHeightTo", wireType)
				}
				x.BonusHeightTo = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.BonusHeightTo |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BonusPercent", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.BonusPercent = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
var (
	...
	fd_GenesisState_validator_bonus_config            protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_validator_bonus_config = md_GenesisState.Fields().ByName("validator_bonus_config")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ValidatorBonusConfig != nil {
		value := protoreflect.ValueOfMessage(x.ValidatorBonusConfig.ProtoReflect())
		if !f(fd_GenesisState_validator_bonus_config, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.distribution.v1beta1.GenesisState.validator_bonus_config":
		return x.ValidatorBonusConfig != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.distribution.v1beta1.GenesisState.validator_bonus_config":
		x.ValidatorBonusConfig = value.Message().Interface().(*ValidatorBonusConfig)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.distribution.v1beta1.GenesisState.validator_bonus_config":
		if x.ValidatorBonusConfig == nil {
			x.ValidatorBonusConfig = new(ValidatorBonusConfig)
		}
		return protoreflect.ValueOfMessage(x.ValidatorBonusConfig.ProtoReflect())
	case "cosmos.distribution.v1beta1.GenesisState.previous_proposer":
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.ValidatorBonusConfig != nil {
			l = options.Size(x.ValidatorBonusConfig)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ValidatorBonusConfig != nil {
			encoded, err := options.Marshal(x.ValidatorBonusConfig)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 11:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ValidatorBonusConfig", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.ValidatorBonusConfig == nil {
					x.ValidatorBonusConfig = &ValidatorBonusConfig{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ValidatorBonusConfig); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type ValidatorBonusConfig struct {
	...
	// validator_whitelist defines the list of validator addresses eligible for bonus
	ValidatorWhitelist []string `protobuf:"bytes,1,rep,name=validator_whitelist,json=validatorWhitelist,proto3" json:"validator_whitelist,omitempty"`
	// bonus_height_to defines the block height until which bonus applies
	BonusHeightTo uint64 `protobuf:"varint,2,opt,name=bonus_height_to,json=bonusHeightTo,proto3" json:"bonus_height_to,omitempty"`
	// bonus_percent defines the percentage bonus (e.g., 10 for 10% bonus)
	BonusPercent string `protobuf:"bytes,3,opt,name=bonus_percent,json=bonusPercent,proto3" json:"bonus_percent,omitempty"`
}

func (x *ValidatorBonusConfig) Reset() {
	*x = ValidatorBonusConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_distribution_v1beta1_genesis_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ValidatorBonusConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidatorBonusConfig) ProtoMessage() {}

// Deprecated: Use ValidatorBonusConfig.ProtoReflect.Descriptor instead.
func (*ValidatorBonusConfig) Descriptor() ([]byte, []int) {
	return file_cosmos_distribution_v1beta1_genesis_proto_rawDescGZIP(), []int{7}
}

func (x *ValidatorBonusConfig) GetValidatorWhitelist() []string {
	if x != nil {
...
func (x *ValidatorBonusConfig) GetBonusHeightTo() uint64 {
	if x != nil {
		return x.BonusHeightTo
	}
	return 0
}

func (x *ValidatorBonusConfig) GetBonusPercent() string {
	if x != nil {
		return x.BonusPercent
	}
	return ""
...
type GenesisState struct {
	...
	ValidatorBonusConfig *ValidatorBonusConfig `protobuf:"bytes,11,opt,name=validator_bonus_config,json=validatorBonusConfig,proto3" json:"validator_bonus_config,omitempty"`
}
...
func (x *GenesisState) GetValidatorBonusConfig() *ValidatorBonusConfig {
	if x != nil {
		return x.ValidatorBonusConfig
	}
	return nil
}
...
var file_cosmos_distribution_v1beta1_genesis_proto_rawDesc = []byte{
	...
	,
	...
	0x62, 0x6f, 0x6e, 0x75, 0x73, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x3a, 0x08, 0x88, 0xa0,
	0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x80, 0x0a, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73,
	0x69, 0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x46, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d,
	...
	0x4a, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x24, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	0x46, 0x65, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0,
	0x2a, 0x01, 0x52, 0x07, 0x66, 0x65, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x77, 0x0a, 0x18, 0x64,
	...
	0x6e, 0x66, 0x6f, 0x73, 0x12, 0x45, 0x0a, 0x11, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73,
	0x5f, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x18, 0xd2, 0xb4, 0x2d, 0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x10, 0x70, 0x72, 0x65, 0x76, 0x69,
	0x6f, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x12, 0x7a, 0x0a, 0x13, 0x6f,
	...
	,
...
var file_cosmos_distribution_v1beta1_genesis_proto_goTypes = []interface{}{
	...
	(*ValidatorBonusConfig)(nil),                 // 7: cosmos.distribution.v1beta1.ValidatorBonusConfig
	...
	(*FeePool)(nil),                              // 16: cosmos.distribution.v1beta1.FeePool
}
var file_cosmos_distribution_v1beta1_genesis_proto_depIdxs = []int32{
	...
	15, // 6: cosmos.distribution.v1beta1.GenesisState.params:type_name -> cosmos.distribution.v1beta1.Params
	16, // 7: cosmos.distribution.v1beta1.GenesisState.fee_pool:type_name -> cosmos.distribution.v1beta1.FeePool
	...
	7,  // 15: cosmos.distribution.v1beta1.GenesisState.validator_bonus_config:type_name -> cosmos.distribution.v1beta1.ValidatorBonusConfig
...
func file_cosmos_distribution_v1beta1_genesis_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_distribution_v1beta1_genesis_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ValidatorBonusConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
